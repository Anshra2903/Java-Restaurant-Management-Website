    ...
    <center style="padding: 25px;">
     <a style="font-size: 15px; color: #1e1e1e; font-family: arial; text-decoration: none;">HI! You are not logged in</a> <br/>
        ...
        <div class="form-style-5">
			...
			<legend><span class="number"></span> Select Your Burger & Quantity</legend>
                                                      <br>
                                                      
                                                      
			
			<select required id="job" name="type" size="1">
                                                            <option value="">Select Your Burger</option>
                                                            <option value="hamburger">Hamburger   |    Price: BDT 150  </option>
                                                            <option value="cheeseburger">Cheeseburger   |    Price: BDT 200</option>
                                                            <option value="doublecheeseburger">Double Cheeseburger   |    Price: BDT 250</option>
