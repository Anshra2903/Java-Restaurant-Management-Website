...
try{ 
connection = DriverManager.getConnection("jdbc:mysql://localhost:3306/rms", "root","");
statement=connection.createStatement();
String sql ="select * from orders ORDER BY orderstatus DESC, ddate ASC";
...
Update Order Id: &nbsp <%=resultSet.getString("oid") %>&nbsp
                ...
                <select required  name="orderstatus" size="1">
                                                   ...
                                                   <option value="waiting">Mark as Waiting Delivery</option>
...
<br>
  ...
  <table style="width:95%" id="<%=resultSet.getString("oid") %>">
  <tr>
    <th>Order ID:</th>
    <th >Order Date:</th>
    <th >Ordered Item:</th>
